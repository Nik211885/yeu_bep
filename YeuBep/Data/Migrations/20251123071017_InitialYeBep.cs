...
{
    /// <inheritdoc />
    public partial class InitialYeBep : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PortionCount = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    TimeToCook = table.Column<string>(type: "character varying(50)", maxLength: 50, nullable: false),
                    CountFavorite = table.Column<int>(type: "integer", nullable: false),
                    CountRatingPoint = table.Column<int>(type: "integer", nullable: false),
                    RecipeStatus = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: false),
                    CreatedById = table.Column<string>(type: "text", nullable: false),
                    ModifiedById = table.Column<string>(type: "text", nullable: false),
                    DetailInstructionSteps = table.Column<string>(type: "jsonb", nullable: true),
                    IngredientPart = table.Column<string>(type: "jsonb", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "text", nullable: false),
                    RecipeId = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    CommentText = table.Column<string>(type: "character varying(800)", maxLength: 800, nullable: false),
                    CreatedById = table.Column<string>(type: "text", nullable: false),
                    ModifiedById = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Favorites_AspNetUsers_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Favorites_ModifiedById",
                table: "Favorites",
                column: "ModifiedById");
