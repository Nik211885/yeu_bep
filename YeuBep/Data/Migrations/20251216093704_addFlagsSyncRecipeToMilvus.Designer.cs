...
namespace YeuBep.Data.Migrations
{
    ...
    [Migration("20251216093704_addFlagsSyncRecipeToMilvus")]
    partial class addFlagsSyncRecipeToMilvus
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YeuBep.Entities.Favorite", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("YeuBep.Entities.Notification", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
                    ...
                    b.Property<int>("NotificationSubject")
                        .HasColumnType("integer");

                    b.Property<string>("SendForUserId")
                        .IsRequired()
                        .HasColumnType("text");
                    ...
                    b.HasIndex("SendForUserId");

                    b.ToTable("Notifications", (string)null);
                });

            modelBuilder.Entity("YeuBep.Entities.Rating", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("YeuBep.Entities.Recipe", b =>
                {
                    ...
                    b.Property<int>("CountRatingPoint")
                        .HasColumnType("integer");
                    ...
                    b.Property<bool>("IsSyncToMilvus")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
            ...
            modelBuilder.Entity("YeuBep.Entities.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("YeuBep.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("YeuBep.Entities.Comment", b =>
                {
                    ...
                    b.HasOne("YeuBep.Entities.Recipe", "Recipe")
                        .WithMany("Comments")
                        .HasForeignKey("RecipeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("YeuBep.Entities.Notification", b =>
                {
                    ...
                    b.HasOne("YeuBep.Entities.User", "SendForUser")
                        .WithMany()
                        .HasForeignKey("SendForUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("YeuBep.Entities.Recipe", b =>
                {
                    ...
                    b.OwnsMany("YeuBep.Entities.DetailInstructionStep", "DetailInstructionSteps", b1 =>
                        {
                            ...
                            b1.ToJson("DetailInstructionSteps");

                            b1.WithOwner()
                                .HasForeignKey("RecipeId");
                        });

                    b.OwnsMany("YeuBep.Entities.IngredientPart", "IngredientPart", b1 =>
                        {
                            b1.Property<string>("RecipeId");
                            ...
                            b1.PrimitiveCollection<string>("Ingredients")
                                .IsRequired();
                    ...
                    b.Navigation("DetailInstructionSteps");

                    b.Navigation("IngredientPart");
